    ...
    <div className="admin-container">
      ...
      <main className="dashboard">
        ...
        <section className="widget-container">
          <WidgetItem percent={40} amount={true} value={425242} heading="revenue" color="rgb(0,115,255)" />
          ...
          <WidgetItem percent={20} value={12000} heading="Products" color="rgb(76,0,255)" />
        </section>
        ...
        <section className="graph-container">
          <div className="revenue-chart">
            ...
            {/* Graph here */}
            <BarChart data_2={[300,144,43,237,755,190,800]} data_1={[200,444,242,556,778,990,700]} title_1="Revenue" title_2="Transaction" bgColor_1="rgb(0,115,255)" bgColor_2="rgba(53,162,235,0.8)"/>
          </div>
